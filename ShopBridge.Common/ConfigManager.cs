...
namespace Shop_Bridge.Common
{
    public class ConfigManager
    {
        ...
        public string ShopBridgeConnectionString => Configuration.GetConnectionString(IsStaging ? AppSettingConstant.CONNECTION_STRING_STAGING : AppSettingConstant.CONNECTION_STRING_PRODUCTION);
